...
const GenerateIdea = () => {
  return (
    <main className="my-20 max-w-[95%] overflow-hidden lg:max-w-[85%] mx-auto ">
      ...
      <section className=" flex gap-10 mt-10 mb-24">
        {/* image div  */}
        <div className=" relative flex-1">
           <Image src={AI} height={500} width={600} alt="AI"></Image>
           <Image className=" absolute border-8 border-gray-100 top-[40%] left-[40%] z-40" src={farm} height={500} width={400} alt="Farm"></Image>
        </div>
        {/* text div */}
