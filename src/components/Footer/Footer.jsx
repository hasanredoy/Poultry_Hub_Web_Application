       ...
       <h3 className=" text-base lg:text-xl font-black">Hub </h3>
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase text- -50">Product</h3>
          ...
          <div className="space-y-3">
            <h3 className="tracking-wide uppercase text- -50">Company</h3>
            <ul className="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="#">
                  Privacy
          ...
          <div className="space-y-3">
            <h3 className="uppercase text- -50">Developers</h3>
            <ul className="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="#">
                  Public API
          ...
          <div className="space-y-3">
            <div className="uppercase text- -50">Social media</div>
